...
call basexclient -U %1 -P %2 -c "repo install %BAT_HOME%\..\..\modules\util\dita-utils.xqm"
call basexclient -U %1 -P %2 -c "repo install %BAT_HOME%\..\..\modules\util\relpath-utils.xqm"
call basexclient -U %1 -P %2 -c "repo list"